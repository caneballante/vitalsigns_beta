	...
	<div id="accordioncontainer">
		...
		<!--*********************************FOLD 02*********************************-->
			...
			<div> 
				...
				<p>This indicator will be used as a baseline from which to assess changes in status for most of the other human wellbeing Vital Sign indicators. The overall life satisfaction indicator will also enable better understanding of how trends in environmental health or recovery efforts are affecting overall human wellbeing.</p>
				<p>Data will be collected every 2 years via survey to Puget Sound residents. Results will be reported as percent of Puget Sound residents that perceive different levels of life satisfaction. The data will be analyzed for significant differences across demographic groups.</p>
