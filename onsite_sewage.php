...
<div id="container">
		...
		<div id="vitalheaderrightphoto"><span class="underconstruction">The Puget Sound Vital Signs site is currently under construction. For the most recent data click here to download the 2015 State of the Sound report</span><span class="photoCredit">Data last updated on July 1, 2015</span></div></div>
		<div id="roundcornerbottom"><img src="img/rounded_rounded_bottom.jpg" width="960" height="20" /></div>
		<!--*********************************TITLE BAR END*********************************-->
			<!--*********************************TAB BEGIN*********************************-->
		
			<ul id="nav_indicator">
			<li class="indicator_active_green"><a href="onsite_sewage.php">Vital Sign Overview<br />
<br />
<br />
</a>
		</li>
		<li><a href="onsite_sewage_indicator1.php">Indicator: <strong>Inventory, inspection, &amp; repair of on-site sewage systems</strong><br />
		</a></li>
				...
				<div id="accordion"> 
						...
						<div>
								<ol>
										...
										<li> Install risers to make it easier to maintain your system. </li>
										<li> Don't flush anything inappropriate down your drain, including kitchen scraps. </li>
										<li> Protect your sewage system's drainfield and reserve area from traffic, landscaping, and other activities that could compact the soil or damage it.</li>
								</ol>
						</div>
							<!--*********************************FOLD 05*********************************-->
						<h3><a href="#!">What our partners are doing</a></h3>
						<div><p><a href="http://gismanager.rco.wa.gov/ntaportal/?VitalSign=On-site+Sewage">View Near Term Actions helping to advance this Vital Sign</a></p> </div>
							<!--*********************************FOLD 06*********************************-->
