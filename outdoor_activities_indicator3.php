	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div> 
			  ...
			  <p>This indicator tracks participation in nature-based occupations in the Puget Sound, such as logging, fishing, agriculture, aquaculture, interpretative work, and nature guiding.</p>
				<p>We are not yet collecting data on this indicator, but when we do, data will be collected every 2 years via survey to Puget Sound residents about their annual nature-based work activities.</p>
				 <p>The results will be reported as the average time Puget Sound residents spend per week engaging in nature-based work. All data will be analyzed for significant differences across demographic groups.</p>
            ...
            <h5>What is the status and trend? <br />
				...
				<p>No data are available for this indicator. We anticipate that data will be collected within the next 2 years, with assessment of trends and progress within the next 4 to 6 years.				</p>
