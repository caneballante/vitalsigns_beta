...
<div id="container">
	...
	<ul id="nav_indicator">
		<li class="indicator_active_blue"><a href="summer_stream_flows.php">Vital Sign: Overview<br />
			<br />
			<br />
			</a></li>
		<li><a href="summer_stream_flows_indicator1.php">Indicator: Summer low flows<br />
			<br />
			</a></li>
	</ul>
	<!-- TAB END -->
	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div>
				...
				<ul>
					<li><a href="http://raingarden.wsu.edu/ ">Washington State University (WSU) Extension - Puget Sound Rain Gardens</a></li>
				</ul>
			</div>
			<!--*********************************FOLD 05*********************************-->
			<h3><a href="#!">What our partners are doing</a></h3>
			<div>
				<p><a href="http://gismanager.rco.wa.gov/ntaportal/?VitalSign=Summer+Streams+Flows">View Near Term Actions helping to advance this Vital Sign</a></p>
			</div>
			<!--*********************************FOLD 06*********************************-->
			<h3><a href="#!">Links for more information</a></h3>
			<div>
				<p><a href="http://www.ecy.wa.gov/programs/eap/flow/shu_main.html" target="_blank">Washington Department of Ecology River and Stream Flow Monitoring</a></p>
