...
<div id="container">
	...
	<ul id="nav_indicator">
		...
		<li class="indicator_active_purp"><a href="estuaries_indicator1.php">Indicator: Estuarine wetlands restored<br />
			<br />
			</a></li>
		<li><a href="estuaries_indicator2.php">Indicator: Chinook salmon rivers meeting recovery goals <br />
			</a></li>
	</ul>
	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div> 
				...
				<p>The area of estuarine wetlands restored to tidal flooding in Puget Sound's large river deltas.</p>
				...
				<h5>2020 target</h5>
				<ul>
					<li>7,380 quality acres of estuarine wetlands are restored basin-wide, which is 20% of total estimated restoration need.</li>
				</ul>
				...
				<p>There has been incremental progress in restoring river estuaries in Puget Sound. Every year, we restore tidal flow to river delta wetlands, or projects are underway to restore tidal flow. We estimate that approximately 2,260 acres of estuarine river delta wetlands have been restored to tidal flooding  between 2006 and 2014, or about 31 percent of the 2020 target. Since 2012, 210 acres, or almost 3 percent of the 2020 target, were restored in the Skagit and Stillaguamish river deltas (respectively, Fisher Slough and Port Susan Bay). In 2013 and 2014, projects were underway to restore river deltas in Puget Sound, but none were officially documented as complete.</p>
			...
			<div> 
				...
				<div> <img src="images/vs16_acresgraph-estuaries.png" width="550" height="525" alt="Estuary acres restored to tidal inundation by year in Puget Sound" /></div>
				<p>Approximately 2,260 acres of estuary lands have been restored to tidal inundation in the 16 major Puget Sound river mouth estuaries  between 2006 and 2014. In 2013 and 2014, projects were underway to restore river deltas in Puget Sound, but none were officially documented as complete. Thus, the acreage value for restoration of tidal flow was zero in both years.</p>
				<p>Data on acres of estuarine lands where tidal flow was restored are provisional because each project characterizes estuary restoration area differently. The Partnership is working with agencies and watershed groups as part of the Delta Consortium to standardize how estuary restoration is measured and reported. </p>
				<h5> Historic trends</h5>
				<p>In Puget Sound there are 16 large river-mouth estuaries: nine larger deltas drain the Cascade Mountains, and seven smaller deltas drain the Olympics. These estuaries and wetlands were a cornerstone of the Puget Sound ecosystem and served as a critical nursery for historically large populations of now-threatened Pacific salmon.</p>
