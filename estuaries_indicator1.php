...
<div id="container">
		...
		<div id="vitalheadercontainer">
				...
				<div id="vitalheaderrightphoto"><span class="underconstruction">The Puget Sound Vital Signs site is currently under construction. For the most recent data click here to download the 2015 State of the Sound report</span><span class="photoCredit">Data last updated on March 24, 2015<br />
                Photo Credit: Russ McMillian</span></div>
		</div>
		...
		<ul id="nav_indicator">
				...
				<li class="indicator_active_purp"><a href="estuaries_indicator1.php">Indicator: Estuarine wetlands restored<br />
						...
						<li><a href="estuaries_indicator2.php">Indicator: Chinook salmon rivers meeting recovery goals
						<br />
						</a></li>
		</ul>
...
<p>Efforts are underway to standardize how river delta restoration efforts are reported and characterized, as part of river delta adaptive management work implemented by the National Oceanic and Atmospheric Administration (NOAA), Washington State Department of Fish and Wildlife (WDFW), and other partners. The intent is to eliminate inconsistencies in how partners track progress, establish methods for detecting problems with wetland recovery, and begin to resolve known issues that may affect delta recovery and resilience over time and under climate change scenarios.
								...
								<h5>2020 target</h5>
								<ul><li>7,380 quality acres of estuarine wetlands are restored basin-wide, which is 20% of total estimated restoration need.</li>
...
<p>Roughly 1,200 acres of restoration are anticipated over the next five years. At this rate, we are not likely to reach the 2020 target. Project work is constrained by limited human resources, unpredictable capital funding flows, and social conflicts over returning low lying farmland to the tides.
</p>
...
<p>Advances in remote sensing technologies, current investments in long term fish monitoring, and strategic investment in delta restoration science promise to improve our understanding of the effects of habitat gains and losses and the natural dynamics of delta ecosystems, allowing us to improve our efficiency by informing where and how to restore these unique and irreplaceable landscapes.
						...
						<img src="images/Chinook_rivers.jpg" width="612" height="749" alt="Chinook salmon river deltas in Puget Sound" />
