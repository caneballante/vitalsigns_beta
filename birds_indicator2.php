	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div> 
				...
				<p>This indicator is the abundance of terrestrial bird populations.</p>
...
<p>Terrestrial bird indicators:</p>
				<ol>
					<li>Breeding abundance trends of resident species associated with interior conifer forests, namely golden-crowned kinglet, varied thrush and brown creeper.</li>
				  	<li>Breeding      abundance trends of resident synanthropic (human-associated) species,      namely American crow, rock pigeon, house sparrow, house finch, and      European starling.</li>
				</ol>
				
				<p>The indicator was chosen because it serves as measures of the size of terrestrial bird populations that reside most, if not all, of the year in Puget Sound. In addition, the indicator provides an integrative view of the health of Puget Sound, in contrast to being indicators of something specific like habitat, contaminants or prey. </p>
...
<p>The terrestrial bird indicator for the Bird Vital Sign was officially endorsed by the Science Panel at their April 9, 2014 meeting. The endorsement was based on a peer-reviewed report written jointly by the Washington State Department of Fish and Wildlife and the Puget Sound Partnership. The report, titled “<a href="http://www.psp.wa.gov/vitalsigns/documents/Pearson and Hamel Bird Indicators 2013_Final.pdf">Marine and Terrestrial Bird Indicators for Puget Sound</a>,” develops, presents and uses a transparent process to identify and evaluate potential indicators and ultimately recommends terrestrial birds. The peer-review process was coordinated by the Puget Sound Partnership Science Panel in 2013. The report was finalized in April of 2014. The indicators were also endorsed by the Leadership Council in January 2014. Supplemental material to the report is linked here.
</p>
			...
			<div>
				...
				<p><span><img src="images/status_no_data.png" width="120" height="123" alt=""/>No data are available yet to assess progress.</p>
				<h5>Latest Data</h5>
