	...
	<div id="accordioncontainer">
		...
		<!--*********************************FOLD 02*********************************-->
			...
			<div> 
				...
				<p>This indicator tells us how many jobs are supported by natural resource industries in Puget Sound. Puget Sound residents have a strong connection to resource-based industries such as fishing, agriculture, timber, and tourism. While we can measure the economic output for these industries, it is also important to monitor how such output relates to the maintenance of job opportunities. Natural resource industries often provide employment to many generations of a family and define a way of life. In addition, employment in these sectors brings individuals in direct contact with the environment, which can develop an ethic of stewardship toward natural resources.</p> 
				<p>This indicator can be used to track changes in the sustainability of employment opportunities in natural resource industries. The data will be compiled from existing sources to provide information on the number of jobs in individual and combined natural resources-based industries in Puget Sound, by county by year.</p>
