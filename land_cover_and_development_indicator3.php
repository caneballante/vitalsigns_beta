	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div> 
				...
				<p>This indicator is the conversion of ecologically important lands.</p>
				...
				<p>This indicator was developed in 2011 as part of a larger effort to define the ecological importance and development pressure on the Puget Sound basin. The technical basis for this indicator can be found here (https://app.box.com/files/0/f/3803565702/Tech_memo).</p>
			...
			<div> 
				...
				<img src="images/landcover_conversion.jpg" width="850" height="598" alt=""/>
				...
				<table width="750" border="1" cellspacing="0" cellpadding="0" class="vstable">
					<tbody>
						<tr>
							<th colspan="5" class="purpBackground"><span class="white">Table 1. Land Cover from Vegetated to Developed Cover, by Land Base Types, in 12 Puget Sound Counties.<br />
								<em>2006-2011</em></span> </th>
						</tr>
						...
						<tr>
							<td colspan="5">*This is the metric that is tracked for the conversion of ecologically important lands indicator<br />
								** This value represents the current status of indicator; the baseline is 0.28% and the 2020 target is 0.15%<br />
								<em>Source: Washington State Department of Fish and Wildlife, Habitat Program. Analysis based on many federal, state and local data sources</em></td>
						</tr>
					</tbody>
				</table>
