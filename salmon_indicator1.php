...
<div id="container">
	...
	<div id="vitalheadercontainer">
		...
		<div id="vitalheaderrightphoto">
			...
			<div class="photoCredit padding-top">Data last updated on March 21, 2014 </div>
		</div>
	</div>
	...
	<ul id="nav_indicator">
		<li><a href="salmon.php">Vital Sign Overview<br />
			<br />
			<br />
			</a> </li>
		<li class="indicator_active_pink"><a href="salmon_indicator1.php">Indicator: Chinook salmon population abundance </a></li>
	</ul>
