	...
	<div id="accordioncontainer">
		<div id="accordion"> 
			...
			<div> 
				...
				<p>This indicator is the number of Southern Resident Killer Whales.</p>
				...
				<p>Southern Resident Killer Whales are a unique population of orcas that ranges in the Salish Sea and the West Coast. These whales eat fish and depend heavily on Chinook salmon for food. In the late-1990s, Southern Resident Killer Whales experienced a dramatic decline. The combination of a precarious food supply and threats from pollution, vessel traffic, and noise continues to jeopardize their survival. As a result, they are federally listed as endangered. </p>
...
<h5>Interim targets</h5>
			...
			<div> 
				...
				<p> <span><img src="images/status_getting_worse.png" width="120" height="123" alt="orca status is getting worse"/>No, this indicator lost ground relative to a baseline reference.<strong></strong></p>
                <p>Although this orca population experienced an uptick in births in 2015, the number of individuals has decreased since 2010, mainly driven by losses of individuals in L pod. The status of the population remains fragile. The 2016 interim target of 91 whales was not met.</p>
                <ul>
                  <li>The July 2016 census led by the Center for Whale Research reported 83 whales. Between 1 July 2015 and 1 July 2016, five southern resident killer whales were born and three have died.</li>
                  <li>Granny, a 105 year old female known as the oldest southern resident, passed away sometime since the 2016 census.</li>
                  <li>In 2010, the census reported 86 individuals, and every year since then the population size was smaller, except in 2011.</li>
                  <li>Although population size has declined since 2010, the population grew, albeit slowly at about 1% per year, between 1979 to 2010. This population growth trend is consistent with the 2020 target. </li>
                  <li>However, trends could easily be reversed, as the Southern Resident Killer Whale population is very vulnerable to a variety of factors, making progress toward the 2020 target tenuous at best.</li>
                </ul>
...
<!-- TABLE 1 -->
				<table width="600" border="1" cellspacing="0" cellpadding="0" class="vstable">
					...
					<tbody>
						<tr>
							<td>End-of-year census of 91 individual Southern Resident Killer Whales.</td>
							<td>No</td>
							<td>In 2016, the census result was 83 whales. </td>
						</tr>
				...
				<h3>FIGURE 1.</h3>
				<h4>FIGURE 1. NUMBER OF SOUTHERN RESIDENT KILLER WHALES IN PUGET SOUND<br />
					<em>1972 - 2016</em></h4>

			  <p><img src="images/VS09_orca_orca.png" height="625" alt="Number of southern resident killer whales in Puget Sound, Annual 1972-2016"/></p>
			  <blockquote><p><em>Source: Center for Whale Research.</em></p></blockquote>
